    ...
    LightBoxObject: {
      ...
      videoregs   : {
        ...
        youtube: {
          ...
          split: '=',
          index: 1,
          url: "//www.youtube.com/embed/%id%?autoplay=1&amp;enablejsapi=1"
        },
        metacafe: {
      ...
      create: function(options) {
        ...
        this.esqueleto.lightbox       = $('<div class="'+this.options.name+' '+this.options.name+'-mode-image"><div class="'+this.options.name+'-border-top-left"></div><div class="'+this.options.name+'-border-top-middle"></div><div class="'+this.options.name+'-border-left"></div><div class="'+this.options.name+'-border-right"></div><div class="'+this.options.name+'-border-top-right"></div><a class="'+this.options.name+'-button-close" href="#close"><span>Close</span></a><div class="'+this.options.name+'-background"></div><div class="'+this.options.name+'-html"></div><div class="'+this.options.name+'-border-bottom-left"></div><div class="'+this.options.name+'-border-bottom-middle"></div><div class="'+this.options.name+'-border-bottom-right"></div><div class="'+this.options.name+'-buttons"><div class="'+this.options.name+'-buttons-init"></div><a class="'+this.options.name+'-button-left" href="#"><span>Previous</span></a><div class="'+this.options.name+'-buttons-custom"></div><a class="'+this.options.name+'-button-right" href="#"><span>Next</span></a><div class="'+this.options.name+'-buttons-end"></div></div></div>');
      ...
      show: function(href, options, callback, anchor) {
        ...
        if (type=='image') {
          ...
          image.onload = $.proxy(function() {
			...
			if(height > 800){
				var objsize_custom = this.calculate(image.width, image.height);
				width   = objsize_custom.width;
                height  = objsize_custom.height;
			}
          ...
          image.onerror = $.proxy(function() {
            this.error("Изображението не може да се зареди. Моля, опитайте по-късно.");
          }, this);
      ...
      swf2html: function(href, width, height) {
        ...
        var str = '<iframe width="1280" height="720" src="'+href+'" frameborder="0" allowfullscreen=""></iframe>';
