...
if(typeof Bnet.D3.Tooltips == 'undefined') Bnet.D3.Tooltips = new function() { // Reminder: Keep in sync with the equivalent code in d3.js
    ...
    var URL_CSS = 'https://{region}.battle.net/d3/static/css/';
    var URL_QUERY_BASE = 'https://{region}.battle.net/d3/{locale}/tooltip/';
    ...
    */
    var URL_PATTERN_BASE = new RegExp('^https://([a-z]{2})\\.battle\\.net/d3/([a-z]{2})/(.+)');
